 ...
 */
class getCategoriasPrincipalesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategoriasPrincipalesRepository' shared autowired service.
     *
     * @return \App\Repository\CategoriasPrincipalesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategoriasPrincipalesRepository.php';

        return $container->privates['App\\Repository\\CategoriasPrincipalesRepository'] = new \App\Repository\CategoriasPrincipalesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
