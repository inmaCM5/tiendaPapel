 ...
 */
class getUnidadesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UnidadesRepository' shared autowired service.
     *
     * @return \App\Repository\UnidadesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UnidadesRepository.php';

        return $container->privates['App\\Repository\\UnidadesRepository'] = new \App\Repository\UnidadesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
