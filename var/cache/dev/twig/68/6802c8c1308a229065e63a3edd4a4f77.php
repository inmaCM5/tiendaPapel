...
/* register.html.twig */
class __TwigTemplate_079b1c49016208b871496b040c20a5bb extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        ";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 9, $this->source); })()), "usuario", [], "any", false, false, false, 9), 'row');
        echo "
        ";
        // line 10
...
{% endblock %}
", "register.html.twig", "C:\\xampp\\htdocs\\tienda\\tiendaPapel\\templates\\register.html.twig");
    }
}
